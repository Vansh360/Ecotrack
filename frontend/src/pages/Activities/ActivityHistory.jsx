...
export default function ActivityHistory() {
  ...
  }, [activities, search, category, dateFilter]);

  const filteredEmission = filteredActivities.reduce(
  ...
  const exportCSV = () => {
    ...
    const rows = filteredActivities.map((activity) => [
      ...
      activity.quantity ?? "",
      activity.unit || "",
      Number(activity.emission || 0).toFixed(3),
    ...
    link.href = url;
    link.download = "ecotrack-activity-history.csv";
  ...
  return (
    <div className="activity-history-page">
      <div className="history-page-header">
        <div>
          <span className="page-eyebrow">ECOTRACK</span>
      ...
      <div className="history-summary">
        ...
        <div className="history-summary-card">
          ...
          <div>
            ...
            <strong>{filteredEmission.toFixed(2)} kg</strong>
          </div>
        </div>
      ...
      <div className="history-table-card">
        {filteredActivities.length === 0 ? (
          <div className="history-empty">
            ...
            <p>Start tracking your transportation, electricity, food, waste or water usage.</p>
          </div>
        ) : (
                  ...
                  <tr key={activity.id}>
                    ...
                    <td>
                      <div className="activity-name">
                        <strong>{activity.activityType || activity.details || "Activity"}</strong>
                    ...
                    <td>
                      <strong className="co2-value">
                        {Number(activity.emission || 0).toFixed(2)} kg
                      </strong>
                    </td>
                    <td>
...
function EditActivityModal({ activity, onClose, onSave }) {
  ...
  const [emission, setEmission] = useState(activity.emission ?? "");
  ...
  const handleSubmit = (e) => {
    ...
    if (emission === "" || Number(emission) < 0) {
      alert("Please enter a valid emission.");
      return;
    }
    ...
    <div className="edit-modal-overlay" onClick={onClose}>
      <div className="edit-modal" onClick={(e) => e.stopPropagation()}>
        <div className="edit-modal-header">
          ...
          <button onClick={onClose} className="close-edit-button">
            <X size={17} />
          </button>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          <div className="edit-form-group">
            ...
            <input value={activity.activityType || activity.details || ""} disabled />
          </div>
          ...
          <div className="edit-actions">
            <button type="button" className="cancel-edit" onClick={onClose}>
              Cancel
            </button>
